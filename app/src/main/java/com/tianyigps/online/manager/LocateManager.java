...
public class LocateManager {
    ...
    private LocateManagerHandler mHandler;
    ...
    private void init() {
        ...
        mHandler = new LocateManagerHandler();
        initLocation();
        initLocationLis();
    }
    ...
    private void initLocationLis() {
        mBdLocationListener = new BDLocationListener() {
            ...
            public void onReceiveLocation(BDLocation bdLocation) {
                ...
                if (null == mOnReceiveLocationListener) {
                    return;
                }
            ...
            public void onConnectHotSpotMessage(String s, int i) {
                Log.i(TAG, "onConnectHotSpotMessage: ");
            }
        };
    }
    ...
    public void setOnReceiveLocationListener(OnReceiveLocationListener listener) {
        this.mOnReceiveLocationListener = listener;
    }

    private class LocateManagerHandler extends Handler {
        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            LatLng latLng = (LatLng) msg.obj;
            mOnReceiveLocationListener.onReceive(latLng);
        }
    }
}
